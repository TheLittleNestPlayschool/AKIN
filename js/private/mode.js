...
export function setupPrivateMode({app,publicMode}){
  const world=document.getElementById("personalWorld"),entryButton=document.getElementById("akinEntryButton"),breakoutButton=document.getElementById("breakoutButton"),carouselElement=document.getElementById("personalCarousel"),hint=document.getElementById("personalWanderHint");
  ...
  entryButton.addEventListener("click",enter);breakoutButton.addEventListener("click",breakout);
